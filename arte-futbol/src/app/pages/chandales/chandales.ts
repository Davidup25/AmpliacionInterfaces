...
@Component({
  ...
  templateUrl: './chandales.html',
  styleUrl: './chandales.css'
})
export class Chandales implements OnInit {
  productos: Producto[] = [];
  ...
  ngOnInit(): void {
    this.todosLosProductos = this.busquedaService.obtenerPorCategoria('chandales');
